...
env = environ.Env(
    ...
    POSTMARK_API_BASE=(str, 'https://api.postmarkapp.com'),
    POSTMARK_TIMEOUT=(int, 8),
    FEEDBACK_SMTP_FALLBACK=(bool, False),
    GUARD_ENABLE_SITEWIDE_ENRICHMENT=(bool, True),
    GUARD_ENABLE_THREAT_FEED_CHECK=(bool, True),
)
...
POSTMARK_API_BASE = env('POSTMARK_API_BASE')
POSTMARK_TIMEOUT = env.int('POSTMARK_TIMEOUT')
FEEDBACK_SMTP_FALLBACK = env.bool('FEEDBACK_SMTP_FALLBACK')
GUARD_ENABLE_SITEWIDE_ENRICHMENT = env.bool('GUARD_ENABLE_SITEWIDE_ENRICHMENT')
GUARD_ENABLE_THREAT_FEED_CHECK = env.bool('GUARD_ENABLE_THREAT_FEED_CHECK')
